                        ...
                        <tbody>
                            ...
                            foreach ($reclamations as $reclamation) {
                                ...
                                echo "<tr>
                                    ...
                                    <a href='/WebProject/View/back/university/update-reclamation.php?id={$reclamation->id_rec}' 
                                    ...
                                    <!-- Bouton Répondre -->
                                    <a href='/WebProject/View/back/university/app-chat.php?id={$reclamation->id_rec}' 
                                        class='btn btn-icon btn-sm text-success' 
                                        data-toggle='tooltip' 
                                    ...
                                    <!-- Bouton Afficher Réponse -->
                                        <a href='/WebProject/View/back/university/afficher-reponse.php?id={$reclamation->id_rec}' 
