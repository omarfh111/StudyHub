...
$reponses = $reponseC->afficherToutesReponses();
...
if (isset($_GET['message']) && $_GET['message'] == 'success_update'): ?>
        ...
        <div class="tab-content mt-3">
            <div class="tab-pane fade show active" id="menu-uni" role="tabpanel">
                ...
                <ul class="metismenu">
                        ...
                        <li class="active"><a href="view-reponse.php"><i class="fa fa-comments-o"></i><span>Reponses Rec</span></a></li>
            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center ">
                    <div class="header-action">
                        <h1 class="page-title">StudyHub</h1>
...
<div class="card" style="width: 200px; border: 1px solid #8d1451; padding: 10px; text-align: center;">
    <h5 style="color: #8d1451;">Nombre de réponses</h5>
    <!-- Vérifier si la variable $nombreDeReponses est définie avant de l'afficher -->
    <p style="font-size: 1.5em; color: #8d1451;"><?= htmlspecialchars($nombreDeReponses); ?></p>
</div>
        
                        </li>
    <!-- Start Displaying Reponses -->
            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    ...
                    <tbody>
                        ...
                        <!-- Bouton Supprimer -->
                        <a href="delete-reponse.php?id_rsp=<?= $reponse['id_rsp']; ?>" 
