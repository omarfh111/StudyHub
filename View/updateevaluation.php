...
if (
    ...
    if (
        ...
        // create an instance of the controller
        $evaluationC->updateevaluation($evaluation);
                            ...
                            <div class="card-body">
                                <div class="row clearfix">
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group">
                                            <label>Nom</label>
                                            <input type="text" id="nom" name="nom" class="form-control"value="<?php echo $evaluation['nom'] ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input  type="datetime-local" id="deadline" name="deadline" class="form-control" placeholder="deadline"value="<?php echo $evaluation['deadline'] ?>">
                                        </div>
                                    </div>
