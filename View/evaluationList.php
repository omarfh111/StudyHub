...
$list = $evaluationC ->listevaluation();
?>
<!doctype html>
...
<div id="main_content">
    ...
    <div class="page">
        ...
        ?> <tr>
            <td><?= $evaluation['idev']; ?></td>
            <td><?= $evaluation['nom']; ?></td>
            <td><?= $evaluation['deadline']; ?></td>
            <td align="center">
                <form method="POST" action="updateevaluation.php">
                    <input type="submit" name="update" value="Update">
                    <input type="hidden" value=<?PHP echo $evaluation['idev']; ?> name="idev">
                </form>
            </td>
            <td>
                <a href="deleteevaluation.php?idev=<?php echo $evaluation['idev']; ?>">Delete</a>
            </td>
            </tr>
        <?php
    }
