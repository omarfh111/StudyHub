...
try {
    $pdo = Config::getConnexion(); // Get the PDO instance
                ...
                <?php foreach ($produits as $produit) : ?>
                    <div class="product-card">
                        ...
                        <div class="action-buttons">
                          <input type="button" value="Buy Now" class="buy-now" onclick="confirmPurchase(<?php echo $produit['idp']; ?>)">
                          <input type="button" value="Add to Cart" class="add-to-cart" onclick="addToCart(<?php echo $produit['idp']; ?>)">
