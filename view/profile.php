...
<head>
  <title>StudyHub &mdash; Profile</title>
  <meta charset="utf-8">
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-lg-3 text-right">
            <a href="login.html" class="small mr-3"><span class="icon-user"></span> <?php echo $nom . " (" . $role . ")"; ?></a>
        ...
        <div class="container">
            <div class="row">
                ...
                <h2>Profil de <?= htmlspecialchars($user['nom']) ?> <?= htmlspecialchars($user['prenom']) ?></h2>
                    ...
                    <p><strong>Status :</strong> <?= htmlspecialchars($user['metier']) ?></p>
