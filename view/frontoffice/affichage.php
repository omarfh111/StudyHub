...
try {
    $sql = "SELECT nomp as product,quantite as quantity,prix_p as price,reduction as discount,types FROM produit";
    ...
    <?php foreach ($produits as $produit) : ?>
        <div class="product-card">
            <div class="product-info">
                <h4><?php echo $produit['product']; ?></h4>
                <p>Prix: <?php echo $produit['price'];?> DT</p>
                <p>discount <?php echo $produit['discount'];?>%</p>
               <input type="checkbox" name="quantite_<?php echo $i; ?>">
            </div>
        </div>
    <?php endforeach; ?>
</div>
