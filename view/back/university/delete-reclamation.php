...
if (isset($_GET['id'])) {
    ...
    header("Location: /login6/View/back/university/app-contact.php?message=success_delete");

} else {
    echo "Erreur : ID invalide.";
    header("Location: /login6/View/back/university/app-contact.php?message=success");
}
