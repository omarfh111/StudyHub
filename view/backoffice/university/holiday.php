                                ...
                                <div class="message">
                                    ...
                                    <div class="file_folder">
                                        <a href="javascript:void(0);">
                                            ...
                                            <div class="file-name">
                                                <p class="mb-0 text-muted">Report2024.xls</p>
            ...
            <div class="tab-pane fade show active" id="menu-uni" role="tabpanel">
                <nav class="sidebar-nav">
                    <ul class="metismenu">
                        ...
                        <li><a href="library.php"><i class="fa fa-book"></i><span>modif offre</span></a></li>
                        <li class="active"><a href="holiday.php"><i class="fa fa-bullhorn"></i><span>affiche commande</span></a></li>
            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center ">
                    ...
                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#Holiday-Calendar">Affiche commande</a></li>
                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#Holiday-all">Produits payés</a></li>
...
if (count($cartItems) > 0) {
    foreach ($cartItems as $item) {
        if ($item['statut'] == 1) { // Check if statut equals 1
            echo '<tr data-idc="' . htmlspecialchars($item['idc']) . '">
                    <td>' . htmlspecialchars($item['user_id']) . '</td>
                    <td>' . htmlspecialchars($item['produit_nom']) . '</td>
