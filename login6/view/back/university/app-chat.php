...
if (isset($_GET['id'])) {
    ...
    // Charger les informations de la réclamation
    $reclamationController = new ReclamationController();
    $reclamation = $reclamationController->getReclamationById($id_rec);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    header("Location: app-chat.php?id=$id_rec");
    exit;
}
...
<link rel="stylesheet" href="/View/back/assets/css/app-chat.css?v=1.0">
...
<div id="main_content">
    ...
    <li class="mr-4">
        <span>Paramètre de la réponse</span>
    </li>
    <div class="actions">
            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <div class="card-header bline">
                        <h3 class="card-title">Champs associés</h3>
                    ...
                    <div class="card-body">
                        ...
                        <form action="/login6/Controller/send.php" method="post" class="form-container">
