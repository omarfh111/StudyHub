...
// Affichez les données de la réponse pour vérifier leur contenu
echo '<pre>';
print_r($response);
echo '</pre>';
?>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="container mt-5">
                            ...
                            <form action="update-reponse.php" method="POST">
    <input type="hidden" name="id_rsp" value="<?= $response['id_rsp']; ?>"> <!-- ID de la réponse -->
    
    <div class="form-group">
        <label for="date_rep">Date de Réponse</label>
        <input type="text" class="form-control" id="date_rep" name="date_rep" value="<?= htmlspecialchars($response['date_rep']); ?>" disabled>
    </div>

    <div class="form-group">
        <label for="reponse">Réponse</label>
        <textarea class="form-control" id="reponse" name="reponse" rows="6" required><?= htmlspecialchars($response['reponse']); ?></textarea>
    </div>
