...
<script src="../assets/js/controlajout.js"></script>
<!-- Core css -->
            ...
            <div class="tab-pane fade show active" id="menu-uni" role="tabpanel">
                <nav class="sidebar-nav">
                    <ul class="metismenu">
                        ...
                        <li class="active"><a href="library.php"><i class="fa fa-book"></i><span>Offres</span></a></li>
            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center ">
                    <div class="header-action">
                        <h1 class="page-title">modif offre</h1>
                        <ol class="breadcrumb page-breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Ericsson</a></li>
                            <li class="breadcrumb-item active" aria-current="page">modif offre</li>
                        </ol>
                    </div>
                    <ul class="nav nav-tabs page-header-tab">
                    <li class="nav-item">
    <form class="form-inline" method="GET" action="search.php">
        <input type="text" name="search" class="form-control" placeholder="What you want to find" required>
        <button type="submit" class="btn btn-primary">Search</button>
    </form>
</li>

                        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#Library-all">Liste des produits</a></li>
            ...
            <div class="container-fluid">
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="Library-add">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Ajout du produit</h3>
                                <div class="card-options ">
    ...
    <div class="site-section">
        <div class="container">
            <div class="row justify-content-center">
                <div class="section-body mt-4">
                     <form id="add-product-form" method="post" action="ajoutoffre.php">
                        <label for="product-name">Product Name:</label>
                        <input type="text" id="name" name="nomp" class="form-control"><br><br>
                        <label type="number" for="quantity">Quantity:</label>
                        ...
                        <button type="submit" class="form-control" onclick="addProduct()">Add Product</button>
                        <br>    
                    </form>
                </div>
            </div>
