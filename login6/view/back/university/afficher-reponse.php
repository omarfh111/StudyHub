...
<link rel="stylesheet" href="login6/View/back/assets/css/app-chat.css" />
...
<div class="section-body mt-4 chat_app">
    ...
    <a href="app-contact.php" 
       style="display: inline-block; background-color: #8d1451; color: white; padding: 10px 20px; border-radius: 5px; text-decoration: none; transition: background-color 0.3s, color 0.3s;"
       onmouseover="this.style.backgroundColor='white'; this.style.color='#8d1451';" 
       onmouseout="this.style.backgroundColor='#8d1451'; this.style.color='white';">
        Retour
    </a>
</div>
