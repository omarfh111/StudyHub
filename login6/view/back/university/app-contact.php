...
<div id="main_content">
    ...
    <div id="left-sidebar" class="sidebar">
        <h5 class="brand-name">StudyHub<a href="javascript:void(0)" class="menu_option float-right"><i class="icon-grid font-16" data-toggle="tooltip" data-placement="left" title="Grid & List Toggle"></i></a></h5>
        <ul class="nav nav-tabs">
        ...
        <div class="tab-content mt-3">
            <div class="tab-pane fade show active" id="menu-uni" role="tabpanel">
                ...
                <ul class="metismenu">
                        ...
                        <li class="active"><a href="app-contact.php"><i class="fa fa-address-book"></i><span>Reclamations</span></a></li>
            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center ">
                    <div class="header-action">
                        <h1 class="page-title">Reclamation</h1>
                    ...
                    <li class="mr-4">
        <span>Afficher toute les reponses </span>
    </li>
                    <a href="view-reponse.php"
                        class="btn btn-icon btn-sm text-success" 
                        data-toggle="tooltip" 
                        title="Afficher toutes les réponses">
                        <i class="fa fa-eye fa-2x"></i> <!-- Icône de visualisation -->
                    </a>
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active" id="list" role="tabpanel">
                <?php if (isset($_GET['message'])): ?>
                    <?php
                    // Vérifie le message et affiche le message approprié
                    if ($_GET['message'] == 'success_update'): ?>
                        <div class="alert alert-success">Réclamation mise à jour avec succès !</div>
                    <?php elseif ($_GET['message'] == 'error_update'): ?>
                        <div class="alert alert-danger">Une erreur s'est produite lors de la mise à jour de la réclamation.</div>
                    <?php elseif ($_GET['message'] == 'success_delete'): ?>
                        <div class="alert alert-success">Réclamation supprimée avec succès !</div>
                    <?php elseif ($_GET['message'] == 'error_delete'): ?>
                        ...
                        <tbody>
                            ...
                            foreach ($reclamations as $reclamation) {
                                ...
                                echo "<tr>
                                    ...
                                    <td>
                                    <!-- Bouton Supprimer -->
                                        <a href='/login6/View/back/university/delete-reclamation.php?id={$reclamation->id_rec}'
                                           class='btn btn-icon btn-sm text-danger hidden-xs js-sweetalert' 
                                           data-type='confirm' 
                                    ...
                                    <a href='/login6/View/back/university/update-reclamation.php?id={$reclamation->id_rec}' 
                                    ...
                                    <!-- Bouton Répondre -->
                                    <a href='/login6/View/back/university/app-chat.php?id={$reclamation->id_rec}' 
                                        class='btn btn-icon btn-sm text-success' 
                                        data-toggle='tooltip' 
                                    ...
                                    <!-- Bouton Afficher Réponse -->
                                        <a href='/login6/View/back/university/afficher-reponse.php?id={$reclamation->id_rec}' 
                                        class='btn btn-icon btn-sm text-success' data-toggle='tooltip' 
                                        title='Afficher La reponse'>
                                        <i class='fa fa-eye'></i>
                                    </a>
